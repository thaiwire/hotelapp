...
import { getBookingsByOwnerId, updateBookingStatusById } from '@/actions/bookings'
...
function HotelOwnerBookingsPage() {
  ...
  useEffect(() => {
    const loadBookings = async () => {
      try {
        ...
        const response = await getBookingsByOwnerId(loggedInUser.id)
